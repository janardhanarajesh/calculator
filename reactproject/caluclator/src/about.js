...
function About()
{
    ...
    <div id="about">
                ...
                <h1 id="abo"> About</h1>
        <p id="para">An electronic calculator is typically a portable electronic device used to perform calculations, ranging from basic arithmetic to complex mathematics.
